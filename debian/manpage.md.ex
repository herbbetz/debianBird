% betz-birdiary(SECTION) | User Commands
%
% "November 25 2025"
...
betz-birdiary - program to do something

# SYNOPSIS

**betz-birdiary** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**betz-birdiary** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **betz-birdiary** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**betz-birdiary** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    betz-birdiary. See **foo.conf**(5) for further details.
...
**betz-birdiary** provides some return codes, that can be used in scripts:
...
herbertbetz <herb-builder@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 herbertbetz
