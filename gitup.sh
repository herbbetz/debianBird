...
REMOTE_URL="git@github.com:herbbetz/debianBird.git"
# this is configured with 'git remote add origin git@github.com:herbbetz/debianBird.git'
# ... see 'git remote -v' inside the WSL dir
