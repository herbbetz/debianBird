...
def shutdown():
   ...
   cmd = f"{birdpath['appdir']}/shutoff.sh orderedDown"
...
def camdata_svg():
   ...
   # Load data from file
   try:
      camdatafile = f"{birdpath['writedir']}/camdata.json"
...
def delrecord():
   ...
   mp4del = f"{birdpath['writedir']}/keep/" + str(data.get('content')) + ".mp4"
   # print(rec2del)
   # print(mp4del)
