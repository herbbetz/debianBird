...
write_dir = birdpath['writedir'] # path to main app directory
keep_dir = write_dir + '/keep/'
...
def readPID(id):
    ...
    fname = f"{birdpath['writedir']}{PIDfile[id]}"
...
def copy2mp4(movesaved):
    h264name = write_dir + 'movements/' + movesaved + '.h264'
